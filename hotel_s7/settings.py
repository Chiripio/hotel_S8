"""
Django settings for hotel_s7 project.
...
SECRET_KEY = 'django-insecure-g1w2p%f8+d38df@rh@(6*7hvg6fu6=1_vmr*9%+zv@$0)0kbq%'
...
ROOT_URLCONF = 'hotel_s7.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ os.path.join(BASE_DIR, 'templates') ],  # <- apunta a /templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
